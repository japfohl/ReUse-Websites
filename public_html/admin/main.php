        ...
        <div class="col-xs-12 col-md-12">
            ...
            <form id="decide">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <button Id="submit" type="submit" class="btn btn-default btn-lg" onclick="addRoute(); return false"
                            align="center">Add to Selected
                    </button>
                </div>
                <div class="col-xs-12 col-md-6">
                    <button Id="submit" type="submit" class="btn btn-default btn-lg" onclick="EditRoute(); return false"
                            align="center">Modify or Delete From Selected
                    </button>
                </div>
            </form>
        </div> <!-- end form -->
